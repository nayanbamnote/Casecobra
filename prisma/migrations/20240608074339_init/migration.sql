...
-- AlterTable
ALTER TABLE "nayan" ADD COLUMN     "color" "CaseColor",
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_configurationId_fkey" FOREIGN KEY ("configurationId") REFERENCES "nayan"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
